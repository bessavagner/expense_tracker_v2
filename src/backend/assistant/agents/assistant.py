...
async def pending_receipt_instructions(ctx: RunContext[AgentScope]) -> str:
...
@assistant_agent.tool
async def get_payment_methods(ctx: RunContext[AgentScope]) -> list[str]:
...
@assistant_agent.tool
async def add_category(ctx: RunContext[AgentScope], name: str, budget_ceiling: str) -> str:
...
async def set_category_budget(
    ctx: RunContext[AgentScope], category_name: str, new_ceiling: str
) -> str:
...
async def add_payment_method(
    ctx: RunContext[AgentScope], name: str, type: str, closing_day: str | None = None
) -> str:
...
@assistant_agent.tool
async def set_income(ctx: RunContext[AgentScope], name: str, amount: str, month: str) -> str:
...
@assistant_agent.tool
async def get_systemic_expenses(ctx: RunContext[AgentScope]) -> list[str]:
...
async def set_systemic_amount(
    ctx: RunContext[AgentScope], name: str, amount: str, month: str
) -> str:
...
@assistant_agent.tool
async def list_recent_entries(ctx: RunContext[AgentScope], limit: int = 10) -> str:
...
@assistant_agent.tool
async def delete_entry(ctx: RunContext[AgentScope], entry_id: str) -> str:
...
async def add_receipt_item(
    ctx: RunContext[AgentScope], description: str, line_total: str, category: str = ""
) -> str:
...
async def get_expenses(
    ctx: RunContext[AgentScope], year: int, month: int, category_name: str | None = None
) -> str:
...
@assistant_agent.tool
async def compare_with_previous_month(ctx: RunContext[AgentScope], year: int, month: int) -> str:
...
@assistant_agent.tool
async def export_monthly_report(ctx: RunContext[AgentScope], year: int, month: int) -> str:
...
@assistant_agent.tool
async def find_anomalies(ctx: RunContext[AgentScope], year: int, month: int) -> str:
...
async def get_category_averages(
    ctx: RunContext[AgentScope], year: int | None = None, month: int | None = None
) -> str:
...
@assistant_agent.tool
async def project_month_end(ctx: RunContext[AgentScope], year: int, month: int) -> str:
...
@assistant_agent.tool
async def get_proactive_alerts(ctx: RunContext[AgentScope], year: int, month: int) -> str:
...
@assistant_agent.tool
async def get_upcoming_obligations(ctx: RunContext[AgentScope], year: int, month: int) -> str:
...
@assistant_agent.tool
async def check_memory(ctx: RunContext[AgentScope], message: str) -> str:
...
async def save_memory_rule(
    ctx: RunContext[AgentScope], trigger: str, field: str, value: str
) -> str:
...
@assistant_agent.tool
async def get_memory_rules(ctx: RunContext[AgentScope]) -> str:
