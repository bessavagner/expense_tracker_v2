...
class TestCategoryBreakdown:
    ...
    def test_empty_month(self, seeded_user, seeded_scope):
        result = analytics.category_breakdown(seeded_scope, 2026, 7)
        assert "nenhum" in result.lower()

    def test_invalid_month(self, seeded_user, seeded_scope):
        result = analytics.category_breakdown(seeded_scope, 2026, 13)
...
class TestMonthlyReportCsv:
    def test_csv_has_header_and_rows(self, seeded_user, seeded_scope, cats):
        ...
        csv = analytics.monthly_report_csv(seeded_scope, 2026, 3)
    ...
    def test_empty_month(self, seeded_user, seeded_scope):
        csv = analytics.monthly_report_csv(seeded_scope, 2026, 7)
...
class TestProjectMonthEnd:
    ...
    def test_no_spend_yet(self, seeded_user, seeded_scope):
        result = analytics.project_month_end(seeded_scope, 2026, 3, today=date(2026, 3, 1))
...
class TestProactiveAlerts:
    ...
    def test_no_alerts_message(self, seeded_user, seeded_scope):
        text = analytics.proactive_alerts(seeded_scope, 2026, 3)
