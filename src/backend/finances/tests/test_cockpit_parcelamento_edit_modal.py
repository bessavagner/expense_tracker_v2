...
class TestCockpitParcelamentoEditModal(TestCase):
    ...
    def test_row_is_clickable(self):
        # The row now opens the plan-management modal (which still reuses this
        # per-parcela edit endpoint inside its "Esta parcela" tab).
        manage_url = f"/cockpit/2026/3/parcelamento/{self.entry.id}/manage/"
