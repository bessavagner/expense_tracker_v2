...
def test_window_stretches_to_the_last_billing_month(user):
...
def test_window_stretches_to_the_last_income_month(user):
    baker.make("finances.Income", user=user, amount=Decimal("100.00"), month=date(2027, 4, 1))
