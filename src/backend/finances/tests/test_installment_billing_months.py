...
class TestInstallmentBillingMonths:
    ...
    def test_credit_card_closes_before_purchase_pushes_first_to_next_month(self):
        """Compra 12/06 num cartão que fecha dia 5 → 1ª parcela cai em julho."""
    ...
    def test_credit_card_closes_after_purchase_keeps_first_in_same_month(self):
        """Compra 12/06 num cartão que fecha dia 25 → 1ª parcela em junho."""
